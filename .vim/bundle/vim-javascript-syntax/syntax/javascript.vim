...
if version >= 508 || !exists("did_javascript_syn_inits")
	...
	HiLink javaScriptBrowserObjects         Conditional

	HiLink javaScriptDOMObjects             Conditional
	HiLink javaScriptDOMMethods             Type
	HiLink javaScriptDOMProperties          Label

	HiLink javaScriptAjaxObjects            Conditional
	...
	HiLink javaScriptPropietaryObjects      Conditional
